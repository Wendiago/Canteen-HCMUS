...
class InventoryApi {
  async createInventoryItem({ token, clientId }, data) {
    try {
      const res = await axios.post(`${LOCAL_URL}/inventoryItems/new/`, data, {
  ...
  async getAllInventoryItems({ token, clientId }) {
    try {
      const res = await axios.get(`${LOCAL_URL}/inventoryItems/all`, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async createGoodReceiveNote({ token, clientId }, data) {
    try {
      const res = await axios.post(`${LOCAL_URL}/inventoryAct/come`, data, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async getAllGoodReceiveNotes({ token, clientId }) {
    try {
      const res = await axios.get(`${LOCAL_URL}/inventoryAct/allcomevoucher`, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async deleteInventoryItems({ token, clientId }, data) {
    try {
      const res = await axios.post(`${LOCAL_URL}/inventoryAct/delete`, data, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async getAllDeletedInventoryItems({ token, clientId }) {
    try {
      const res = await axios.get(
        `${LOCAL_URL}/inventoryAct/alldeletevoucher`,
        { headers: configHeader({ token, clientId }) }
      );
      return res.data;
    } catch (error) {
  ...
  async createGoodDeliveryNote({ token, clientId }, data) {
    try {
      const res = await axios.post(`${LOCAL_URL}/inventoryAct/leave`, data, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async getAllGoodDeliveryNotes({ token, clientId }) {
    try {
      const res = await axios.get(`${LOCAL_URL}/inventoryAct/allleavevoucher`, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
  ...
  async getAllExpiredProduct({ token, clientId }) {
    try {
      const res = await axios.get(`${LOCAL_URL}/inventoryItems/expired`, {
        headers: configHeader({ token, clientId }),
      });
      return res.data;
    } catch (error) {
