  ...
  const handleCreateGRN = (list) => {
    const createGoodReceiveNote = async () => {
      try {
        ...
        const res = await InventoryApi.createGoodReceiveNote(
          { token, clientId },
          body
        );
        if (res.error) {
        ...
        const expiredRes = await InventoryApi.getAllExpiredProduct({
          token,
          clientId,
        });
  ...
  const handleCreateGDN = (list) => {
    const createGoodDeliveryNote = async () => {
      try {
        ...
        const res = await InventoryApi.createGoodDeliveryNote(
          { token, clientId },
          body
        );
        if (res.error) {
